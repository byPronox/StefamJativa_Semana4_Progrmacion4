...
namespace StefamJativa_Semana4_Progrmacion4.Controllers
{
    public class CarrerasController : Controller
    {
        private readonly StefamJativa_Semana4_Progrmacion4Context _context;

        public CarrerasController(StefamJativa_Semana4_Progrmacion4Context context)
        {
            _context = context;
        }
